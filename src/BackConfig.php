...
class BackConfig extends AbstractConfig
{
    ...
    public function __construct(Application $application)
    {
        ...
        $this->filename = $this->app->appDir() . "App" . DIRECTORY_SEPARATOR . "Backend" . DIRECTORY_SEPARATOR . "config" . DIRECTORY_SEPARATOR . "app.json";
